...
// Structure of a CFile
typedef struct CFILE {
	FILE 		    *file;          // Pointer to the file itself
	int				size;           // Size
	int				lib_offset;     // ?
	int				raw_position;   // A pointer to a specific part in the file
} CFILE;
...
// Find a specific file in the 3ds filesystem
