...
//start the frame
ITCM_CODE void g3_start_frame(void);
...
//end the frame
ITCM_CODE void g3_end_frame(void);
...
//instance at specified point with specified orientation
ITCM_CODE void g3_start_instance_angles(vms_vector *pos,vms_angvec *angles);

//pops the old context
ITCM_CODE void g3_done_instance();
...
ITCM_CODE ubyte g3_rotate_point(g3s_point *dest,vms_vector *src);

//projects a point
void g3_project_point(g3s_point *point);

//calculate the depth of a point - returns the z coord of the rotated point
ITCM_CODE fix g3_calc_point_depth(vms_vector *pnt);

//from a 2d point, compute the vector through that point
void g3_point_2_vec(vms_vector *v,short sx,short sy);

//code a point.  fills in the p3_codes field of the point, and returns the codes
ITCM_CODE ubyte g3_code_point(g3s_point *point);
...
typedef void (*g3_draw_tmap_func_t)(int nv,vms_vector **pointlist,g3s_uvl *uvl_list,grs_bitmap *bm);
extern void (*g3_draw_tmap_func)(int nv,vms_vector **pointlist,g3s_uvl *uvl_list,grs_bitmap *bm);
...
ITCM_CODE bool g3_check_and_draw_poly(int nv,g3s_point **pointlist,vms_vector *norm,vms_vector *pnt);
ITCM_CODE bool g3_check_and_draw_tmap(int nv,g3s_point **pointlist,g3s_uvl *uvl_list,grs_bitmap *bm,vms_vector *norm,vms_vector *pnt);
...
//returns 1 if off screen, 0 if drew
ITCM_CODE void g3_draw_rod_flat(vms_vector *bot_point,fix bot_width,vms_vector *top_point,fix top_width);

//draw a bitmap object that is always facing you
//returns 1 if off screen, 0 if drew
ITCM_CODE void g3_draw_rod_tmap(grs_bitmap *bitmap,vms_vector *bot_point,fix bot_width,vms_vector *top_point,fix top_width,fix light);
...
ITCM_CODE bool g3_draw_polygon_model(void *model_ptr,grs_bitmap **model_bitmaps,vms_angvec *anim_angles,fix light,fix *glow_values);

//init code for bitmap models
void g3_init_polygon_model(void *model_ptr);

//alternate interpreter for morphing object
ITCM_CODE bool g3_draw_morphing_model(void *model_ptr,grs_bitmap **model_bitmaps,vms_angvec *anim_angles,fix light,vms_vector *new_points);
