...
ITCM_CODE fix compute_headlight_light(vms_vector *point,fix face_light)
{
	fix light;
...
ITCM_CODE fix compute_seg_dynamic_light(int segnum)
{
	fix sum;
	segment *seg;
	short *verts;
...
ITCM_CODE fix compute_object_light(object *obj,vms_vector *rotated_pnt)
{
	fix light;
	g3s_point objpnt;
