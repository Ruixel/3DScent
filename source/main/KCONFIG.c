...
{
    // 3DS Default scheme
    /*  0 pitch fwd        */ 0x4d, 0xff,  // C-pad down (inverted)
    /*  2 pitch back       */ 0x47, 0xff,  // C-pad up
    /*  4 turn left        */ 0x48, 0xff,  // C-pad left
    /*  6 turn right       */ 0x49, 0xff,  // C-pad right
    /*  8 slide on         */ 0xff, 0xff,
    /* 10 slide left       */ 0x50, 0xff,  // C-stick left
    /* 12 slide right      */ 0x51, 0xff,  // C-stick right
    /* 14 slide up         */ 0x52, 0xff,  // C-stick down (inverted)
    /* 16 slide down       */ 0x4f, 0xff,  // C-stick up
    /* 18 bank on          */ 0xff, 0xff,
    /* 20 bank left        */ 0x17, 0xff,  // ZL
    /* 22 bank right       */ 0x16, 0xff,  // ZR
    /* 24 fire primary     */ 0x13, 0xff,  // R
    /* 26 fire secondary   */ 0x26, 0xff,  // L
    /* 28 fire flare       */ 0x15, 0xff,  // Y
    /* 30 accelerate       */ 0x1e, 0xff,  // A
    /* 32 reverse          */ 0x30, 0xff,  // B
    /* 34 drop bomb        */ 0xff, 0xff,  // unbound
    /* 36 rear view        */ 0x2d, 0xff,  // X
    /* 38 cruise faster    */ 0xff, 0xff,
    /* 40 cruise slower    */ 0xff, 0xff,
    /* 42 cruise off       */ 0xff, 0xff,
    /* 44 automap          */ 0x0f, 0xff,  // Select
    /* 46 cycle prim next  */ 0xcd, 0xff,  // D-pad right
    /* 48 cycle prim prev  */ 0xcb, 0xff,  // D-pad left
    /* 50 cycle sec next   */ 0xc8, 0xff,  // D-pad up
    /* 52 cycle sec prev   */ 0xd0, 0xff,  // D-pad down
    /* 54 pad              */ 0xff, 0xff, 0xff, 0xff,
},
// PSX-inspired scheme
// Row 1: PSX (faithful to manual)
{
    /*  0 pitch fwd        */ 0x4d, 0xff,  // C-pad down (inverted)
    /*  2 pitch back       */ 0x47, 0xff,  // C-pad up
    /*  4 turn left        */ 0x48, 0xff,  // C-pad left
    /*  6 turn right       */ 0x49, 0xff,  // C-pad right
    /*  8 slide on         */ 0xff, 0xff,
    /* 10 slide left       */ 0x15, 0xff,  // Y (PSX Square)
    /* 12 slide right      */ 0x1e, 0xff,  // A (PSX Circle)
    /* 14 slide up         */ 0xff, 0xff,
    /* 16 slide down       */ 0xff, 0xff,
    /* 18 bank on          */ 0xff, 0xff,
    /* 20 bank left        */ 0x17, 0xff,  // ZL (PSX L2)
    /* 22 bank right       */ 0x16, 0xff,  // ZR (PSX R2)
    /* 24 fire primary     */ 0x26, 0xff,  // L (PSX L1)
    /* 26 fire secondary   */ 0x13, 0xff,  // R (PSX R1)
    /* 28 fire flare       */ 0xff, 0xff,
    /* 30 accelerate       */ 0x2d, 0xff,  // X (PSX Triangle)
    /* 32 reverse          */ 0x30, 0xff,  // B (PSX X)
    /* 34 drop bomb        */ 0xff, 0xff,
    /* 36 rear view        */ 0xff, 0xff,
    /* 38 cruise faster    */ 0xff, 0xff,
    /* 40 cruise slower    */ 0xff, 0xff,
    /* 42 cruise off       */ 0xff, 0xff,
    /* 44 automap          */ 0x0f, 0xff,  // Select
...
{0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x1,0x1,0x0,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},
...
kc_item kc_joystick[NUM_OTHER_CONTROLS] = {
	{  0, 25, 46, 85, 26, 15,  1, 23,  5,390,   3, 255 },
	{  1, 25, 54, 85, 26,  0,  4,  5,  6,391,   3, 255 },
	{  2, 25, 85, 85, 26, 26,  3,  9, 10,393,   3, 255 },
	{  3, 25, 93, 85, 26,  2, 25, 10, 11,394,   3, 255 },
	{  4, 25, 62, 85, 26,  1, 26,  6,  7,392,   3, 255 },
	{  5,180, 46, 59, 26, 23,  6,  0,  1,382,   3, 255 },
	{  6,180, 54, 59, 26,  5,  7,  1,  4,383,   3, 255 },
	{  7,180, 62, 59, 26,  6,  8,  4, 26,384,   3, 255 },
	{  8,180, 70, 59, 26,  7,  9, 26,  9,385,   3, 255 },
	{  9,180, 78, 59, 26,  8, 10,  8,  2,386,   3, 255 },
	{ 10,180, 90, 59, 26,  9, 11,  2,  3,387,   3, 255 },
	{ 11,180, 98, 59, 26, 10, 12,  3, 12,388,   3, 255 },
	{ 12,180,106, 59, 26, 11, 13, 11, 25,389,   3, 255 },
	{ 13, 22,146, 51, 26, 12, 15, 25, 14,399,   4, 255 },
	{ 14, 22,146, 99,  8, 25, 16, 13, 17,399,   5, 255 },
	{ 15, 22,154, 51, 26, 13,  0, 17, 16,400,   4, 255 },
	{ 16, 22,154, 99,  8, 14, 17, 15, 19,400,   5, 255 },
	{ 17,164,146, 58, 26, 16, 19, 14, 15,401,   4, 255 },
	{ 18,164,146,106,  8, 12, 20, 17, 15,401,   5, 255 },
	{ 19,164,154, 58, 26, 17, 21, 16, 21,402,   4, 255 },
	{ 20,164,154,106,  8, 18, 22, 19, 21,402,   5, 255 },
	{ 21,164,162, 58, 26, 19, 23, 19, 23,403,   4, 255 },
	{ 22,164,162,106,  8, 20, 24, 21, 23,403,   5, 255 },
	{ 23,164,174, 58, 26, 21,  5, 21,  0,404,   4, 255 },
	{ 24,164,174,106,  8, 22, 13, 23,  0,404,   5, 255 },
	{ 25, 25,109, 85, 26,  3, 14, 12, 13,311,   3, 255 },
	{ 26, 25, 70, 85, 26,  4,  2,  7,  8,395,   3, 255 },
};
*/
kc_item kc_mouse[NUM_OTHER_CONTROLS] = {
	{  0,  0,  0,  0,  0, 42,  13, 22,  0,  0,   6, 255 },
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
	...
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
	{ 13,103,54, 58, 26, 24, 15, 24, 14,399,  2, 255 },
	{ 14,103,54,106,  8, 23, 16, 13, 15,399,  5, 255 },
	{ 15,103,62, 58, 26, 13, 17, 14, 16,400,  2, 255 },
	{ 16,103,62,106,  8, 14, 18, 15, 17,400,  5, 255 },
	{ 17,103,70, 58, 26, 15, 19, 16, 18,401,  2, 255 },
	{ 18,103,70,106,  8, 16, 20, 17, 19,401,  5, 255 },
	{ 19,103,78, 58, 26, 17, 21, 18, 20,402,  2, 255 },
	{ 20,103,78,106,  8, 18, 22, 19, 21,402,  5, 255 },
	{ 21,103,86, 58, 26, 19, 23, 20, 22,403,  2, 255 },
	{ 22,103,86,106,  8, 20, 24, 21, 23,403,  5, 255 },
	{ 23,103,94, 58, 26, 21, 14, 22, 24,404,  2, 255 },
	{ 24,103,94,106,  8, 22, 13, 23, 13,404,  5, 255 },
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
	{  0,  0,  0,  0,  0, 42,  0, 22,  0,  0,   6, 255 },
};
/*
...
//	grs_canvas * save_canvas;
	...
	if ( items == kc_keyboard )	{
		...
		background = gr_create_bitmap( grd_curcanv->cv_bitmap.bm_w, grd_curcanv->cv_bitmap.bm_h );
		Assert( background != NULL );
		gr_bm_bitblt(grd_curcanv->cv_bitmap.bm_w, grd_curcanv->cv_bitmap.bm_h, 0, 0, 0, 0, &grd_curcanv->cv_bitmap, background );
		show_sk = 1;
		softkey_enable (1);
	}
...
//	gr_string( 0x8000, 40, TXT_KCONFIG_STRING_1 );
	...
	if ( items == kc_joystick )	{
		...
		gr_set_fontcolor( BM_XRGB(31,27,6), -1 );
		gr_setcolor( BM_XRGB(31,27,6) );
		gr_scanline( 18, 112, 37 );
		gr_scanline( 141, 237, 37 );
//		gr_scanline( 18, 112, 119+5 );
//		gr_scanline( 141, 237, 119+5 );
//		gr_string( 0x8000, 35, TXT_BUTTONS );
		gr_string( 0x8000,35, TXT_AXES );
		gr_set_fontcolor( BM_XRGB(28,28,28), -1 );
		gr_string( 167, 42, TXT_AXIS );
		gr_string( 199, 42, TXT_INVERT );
	}
...
//			gr_set_current_canvas( save_canvas );
			...
			{
				gr_set_current_canvas (&VR_screen_pages[0]);
				gr_bitmap(0, 0, background); 	
				gr_free_bitmap(background);
				gr_set_current_canvas (&VR_screen_pages[1]);
				softkey_enable (0);
			}
...
//	case 1:kconfig_sub( kc_joystick, NUM_OTHER_CONTROLS, title );break;
	...
	for (i=0; i<NUM_KEY_CONTROLS; i++ )	
		kconfig_settings[0][i*2] = kc_keyboard[i*2].value;
...
//	kc_use_external_control = 1;
	...
	printf( "%s int: 0x%x, data: 0x%x\n", TXT_EXTERNAL_CONTROL, kc_external_intno, (int)kc_external_control );
}
*/
/*
...
//	if (Config_control_type==5 ) {
	...
	if ( Config_control_type == 5 ) {
//		LastReadTime = ctime = 0;
		//---------  Read Mouse -----------
		mouse_get_delta( &dx, &dy );
		mouse_axis[0] = (dx*FrameTime)>>1;
		mouse_axis[1] = (dy*FrameTime)>>1;
...
//----------- Read vertical_thrust_time -----------------
	...
	if ( slide_on )	{
		// From keyboard...
		if ( kc_keyboard[0].value < 255 ) Controls.vertical_thrust_time += speed_factor*key_down_time( kc_keyboard[0].value );
//		if ( kc_keyboard[1].value < 255 ) Controls.vertical_thrust_time += speed_factor*key_down_time( kc_keyboard[1].value );
		if ( kc_keyboard[2].value < 255 ) Controls.vertical_thrust_time -= speed_factor*key_down_time( kc_keyboard[2].value );
//		if ( kc_keyboard[3].value < 255 ) Controls.vertical_thrust_time -= speed_factor*key_down_time( kc_keyboard[3].value );
...
//----------- Read sideways_thrust_time -----------------
	...
	if ( slide_on )	{
		// From keyboard...
		if ( kc_keyboard[4].value < 255 ) Controls.sideways_thrust_time -= speed_factor*key_down_time( kc_keyboard[4].value );
//		if ( kc_keyboard[5].value < 255 ) Controls.sideways_thrust_time -= speed_factor*key_down_time( kc_keyboard[5].value );
		if ( kc_keyboard[6].value < 255 ) Controls.sideways_thrust_time += speed_factor*key_down_time( kc_keyboard[6].value );
//		if ( kc_keyboard[7].value < 255 ) Controls.sideways_thrust_time += speed_factor*key_down_time( kc_keyboard[7].value );
...
//----------- Read bank_time -----------------
	...
	if ( bank_on )	{
		// From keyboard...
		if ( kc_keyboard[4].value < 255 ) Controls.bank_time += speed_factor*key_down_time( kc_keyboard[4].value );
//		if ( kc_keyboard[5].value < 255 ) Controls.bank_time += speed_factor*key_down_time( kc_keyboard[5].value );
		if ( kc_keyboard[6].value < 255 ) Controls.bank_time -= speed_factor*key_down_time( kc_keyboard[6].value );
//		if ( kc_keyboard[7].value < 255 ) Controls.bank_time -= speed_factor*key_down_time( kc_keyboard[7].value );
...
//----------- Clamp values between -FrameTime and FrameTime
	...
	if (use_mouse)
	{
//		if ((kc_mouse[8].value < 255 )) Controls.vertical_thrust_time += mouse_button_down_time( kc_mouse[8].value );
//		if ((kc_mouse[9].value < 255 )) Controls.vertical_thrust_time -= mouse_button_down_time( kc_mouse[9].value );
//		if ((kc_mouse[10].value < 255 )) bank_on |= mouse_buttons & (1<<kc_mouse[10].value);
//		if ((kc_mouse[5].value<255)) slide_on |= mouse_buttons & (1<<kc_mouse[5].value);
...
//		if ((kc_mouse[6].value < 255 )) Controls.sideways_thrust_time -= mouse_button_down_time( kc_mouse[6].value );
//		if ((kc_mouse[7].value < 255 )) Controls.sideways_thrust_time += mouse_button_down_time( kc_mouse[7].value );
...
//		if ((kc_mouse[11].value < 255 )) Controls.bank_time += mouse_button_down_time( kc_mouse[11].value );
//		if ((kc_mouse[12].value < 255 )) Controls.bank_time -= mouse_button_down_time( kc_mouse[12].value );
...
//		if ((kc_mouse[2].value < 255 )) Controls.forward_thrust_time += mouse_button_down_time( kc_mouse[2].value );
//		if ((kc_mouse[3].value < 255 )) Controls.forward_thrust_time -= mouse_button_down_time( kc_mouse[3].value );
...
void kc_set_controls()
{
	...
	for (i=0; i<NUM_KEY_CONTROLS; i += 2 )
