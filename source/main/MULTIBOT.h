...
void multi_do_robot_explode(ubyte *buf);
void multi_do_robot_position(ubyte *buf);
void multi_do_claim_robot(ubyte *buf);
void multi_do_release_robot(ubyte *buf);
void multi_do_robot_fire(ubyte *buf);
void multi_do_create_robot(ubyte *buf);
void multi_do_boss_actions(ubyte *buf);
void multi_do_create_robot_powerups(ubyte *buf);
