...
#define vm_vec_normalize(v) vm_vec_copy_normalize(v,v)

//normalize a vector. returns mag of source vec. uses approx mag
ITCM_CODE fix vm_vec_copy_normalize_quick(vms_vector *dest,vms_vector *src);
#define vm_vec_normalize_quick(v) vm_vec_copy_normalize_quick(v,v)
...
ITCM_CODE vms_matrix *vm_vector_2_matrix_norm(vms_matrix *m,vms_vector *fvec,vms_vector *uvec,vms_vector *rvec);
